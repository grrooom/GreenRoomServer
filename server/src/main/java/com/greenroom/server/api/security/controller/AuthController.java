...
public class AuthController {
    ...
    @PutMapping("/tokens")
    public ResponseEntity<ApiResponse> updateToken(@RequestBody TokenRequestDto tokenRequestDto){
   ...
   //일반 로그인
    ...
    public ResponseEntity<ApiResponse> authenticateEmail(@RequestBody EmailAuthenticationDto.EmailAuthDto authenticationDto){
    ...
    public ResponseEntity<ApiResponse> verifyEmailToken(@RequestBody EmailAuthenticationDto.EmailTokenAuthDto authenticationDto){
